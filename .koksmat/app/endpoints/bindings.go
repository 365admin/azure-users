...
func AddEndpoints(s *web.Service, jwtAuth func(http.Handler) http.Handler) {
	s.Route("/v1", func(r chi.Router) {
		r.Group(func(r chi.Router) {
			...
			r.Method(http.MethodPost, "/magic/pep.pl", nethttp.NewHandler(MagicPepplPost()))
			...
			r.Method(http.MethodPost, "/tasks/sync-guests", nethttp.NewHandler(TasksSyncGuestsPost()))
			r.Method(http.MethodPost, "/azuread/find-users", nethttp.NewHandler(AzureadFindUsersPost()))
